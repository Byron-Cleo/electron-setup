...
### Step 2: Generate Frontend (deepseek-coder:latest)
```bash
ollama run deepseek-coder:latest "<frontend prompt>" > /tmp/deepseek_frontend_output.txt
```
...
3. If vision data exists, append design reference section
 4. Send to deepseek-coder:latest
